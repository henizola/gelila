...
sub Read_Config {
	...
	# Standard, Mandrake and Debian package :	"/home/henockqe/domains/henockzelalem.com/awstats/test/.data"
	# Other possible directories :				"/usr/local/etc/awstats",
	# FHS standard, Suse package : 				"/etc/opt/awstats"
	my $configdir         = shift;
	my @PossibleConfigDir = (
			"$DIR",
			"/home/henockqe/domains/henockzelalem.com/awstats/test/.data",
